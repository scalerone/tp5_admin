                     ...
                     <form class="form-horizontal">
                    	...
                    	<div class="col-md-3 col-sm-12 col-xs-12 form-group pull-right ">
			                  <div class="input-group">
			                    <input type="text"  id="nameSearch" class="form-control" placeholder="用户名" value="<?php echo $param['uname']; ?>">
                        ...
                        <thead>
							<tr class="headings">
								...
								<th class="column-title">操作内容 </th>
								<th class="column-title">时间 </th>
								<th class="column-title no-link last"><span class="nobr">登录IP</span>
								</th>
                        ...
                        <tbody>
                            <?php if(is_array($pageData->items()) || $pageData->items() instanceof \think\Collection): $i = 0; $__LIST__ = $pageData->items();if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								<tr class="even pointer">
							
									<td class=" "><?php echo $vo['id']; ?></td>
									<td class=" "><?php echo $vo['uname']; ?></td>
									<td class=" "><?php echo $vo['menu']; ?>:<?php echo $vo['content']; ?></td>
									<td class=" "><?php echo $vo['Createtime']; ?></td>
									<td class=" last">
										<?php echo $vo['login_ip']; ?>
									</td>
								</tr>
