	...
	<div class="table-responsive">
		<form class="form-horizontal">
			<div class="col-md-2 col-sm-12 col-xs-12 form-group">
				<?php if((checkPopedom('/admin/article/add'))): ?>
				<a href="<?php echo url('/admin/article/add'); ?>" class="btn btn-sm btn-success" ><i class="fa fa-plus-square"></i> 新增</a>
				<?php endif; ?>
			</div>
			<form class="form-horizontal">
				<div class="input-group col-md-3 col-sm-4 col-xs-12 form-group pull-right">
					<input type="text" name="keywords" id="nameSearch" class="form-control form-param-to" placeholder="文章名" value="<?php echo $param['keywords']; ?>">
				...
				<div class="col-md-2 col-sm-12 col-xs-12 form-group pull-right">
					<select  x-listen  class="form-control form-param-to" name="classID">
						...
						<?php if(is_array($class) || $class instanceof \think\Collection): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<option value="<?php echo $vo['id']; ?>" <?php echo ($vo['id']==$param['classID'])?"selected":""; ?>><?php echo $vo['Vc_name']; ?></option>
		...
		<table class="table table-striped jambo_table bulk_action">
			...
			<tr class="even pointer">
				...
				<td class=" "><?php echo cutstrnohtml($vo['Vc_name'],16); ?></td>
				<td class=" "><?php echo cutstrnohtml($vo['Vc_intro'],16); ?></td>
				<td class=" "><?php echo cutstrnohtml($vo['classname'],16); ?></td>
				<td class=" "><?php echo $vo['D_releasetime']; ?></td>
				<td class=" "><?php echo $vo['I_order']; ?></td>
				<td class=" "><?php echo $vo['Createtime']; ?></td>
				<td class=" last">
					<?php if((checkPopedom('/admin/article/edit'))): ?>
					<a href="<?php echo url('admin/article/edit',['id'=>$vo['id']]); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 编辑</a>
					<?php endif; if((checkPopedom('/admin/article/del') && $vo['I_dodel']==1)): ?>
					<a href="javascript:void(0);" data-href="<?php echo url('admin/article/del',['id'=>$vo['id']]); ?>"  class="btn btn-danger btn-xs js-ajax-delete"  ><i class="fa fa-trash-o"></i> 删除 </a>
					<?php endif; ?>
				</td>
			</tr>
			<?php endforeach; endif; else: echo "" ;endif; ?>
