...
<div class="x_content">
    ...
    <form id="configure-info-submit"  class="form-horizontal form-label-left" novalidate>
        <div class="form-group item">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control "  name="I_article_classID" required>
                    ...
                    <option <?php if(($data['I_article_classID']==$vo['id'])): ?>selected<?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['Vc_name']; ?></option>
        ...
        <div class="form-group item ">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" value="<?php echo $data['Vc_name']; ?>"  name="Vc_name" datatype="s1-30"  errormsg="参数代码 至少1个字符,最多30个字符！"  maxlength="50" required="required" class="form-control col-md-7 col-xs-12">
        ...
        <div class="form-group item ">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text"  name="Vc_intro" datatype="s1-255" value="<?php echo $data['Vc_intro']; ?>"  errormsg="参数代码 至少1个字符,最多255个字符！"  maxlength="255" required="required" class="form-control col-md-7 col-xs-12">
                <div class="Validform_checktip"></div>
            </div>
        </div>
        <div class="form-group item">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
                <script type="text/plain" id="T_content" name="T_content" ><?php echo $data['T_content']; ?></script>
            </div>
        </div>
        <div class="form-group item">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12  ">
                    ...
                    <input type="text" class="form-control has-feedback-left " value="<?php echo $data['D_releasetime']; ?>" id="D_releasetime" placeholder=""  name="D_releasetime">
                </div>
            </div>
        ...
        <div class="form-group item">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <select class="form-control "  name="I_dodel"  required>
                    <option value="1" <?php if(($data['I_dodel']==1)): ?>selected<?php endif; ?>>是</option>
                    <option value="2" <?php if(($data['I_dodel']==2)): ?>selected<?php endif; ?>>否</option>
                </select>
            </div>
        </div>
        <div class="form-group item">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input  type="number" id="sort"  name="I_order" data-validate-minmax="1,10000" value="<?php echo $data['I_order']; ?>" pattern="numeric" required="required" class="form-control col-md-7 col-xs-12">
