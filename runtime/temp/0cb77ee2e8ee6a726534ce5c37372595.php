                     ...
                     <form class="form-horizontal">
                    	...
                    	<div class="col-md-3 col-sm-12 col-xs-12 form-group pull-right ">
                              <div class="input-group">
                                <input type="text"  id="nameSearch" class="form-control" placeholder="参数代码" value="<?php echo $code; ?>">
                        ...
                        <tbody>
                            <?php if(is_array($page->items()) || $page->items() instanceof \think\Collection): $i = 0; $__LIST__ = $page->items();if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								...
								<!-- 	<td class="a-center ">
									...
									<td class=" "><?php echo cutstrnohtml($vo['code'],16); ?></td>
									<td class=" "><?php echo cutstrnohtml($vo['note'],16); ?></td>
									<td class=" "><?php echo cutstrnohtml($vo['value'],16); ?></td>
									<td class=" "><?php echo $vo['Createtime']; ?></td>
									<td class=" last">
								<?php if((checkPopedom('/admin/configure/edit'))): ?>
                            <a href="<?php echo url('admin/configure/edit',['id'=>$vo['id']]); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> 编辑</a>
                            <?php endif; ?>
									</td>
								</tr>
...
$(document).ready(function(){
    ...
    $('#updateCache').click(function(){
        $.getJSON("<?php echo url('admin/configure/updateCache'); ?>")
